from random_agents.multipleAgents import RandomAgent, ObstacleAgent, ChargingStationAgent, TrashAgent
from random_agents.multipleModel import RandomModel
...
model_params = {
    ...
    "max_steps": Slider("Max Steps", 200, 50, 3500, 50),
}
